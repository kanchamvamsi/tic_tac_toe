...
public class Tic_tac_toe {
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btn2.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btn4.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btn5.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btn6.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		oCount.setText("0");
		panel_12.add(oCount, BorderLayout.CENTER);
		...
		btn7.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btn8.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btn9.setFont(new Font("Segoe UI Semibold", Font.BOLD, 79));
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "confirm you want exit","tic tac toe ",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION)
				{
					System.exit(0);
				}
		...
		panel_2.add(btnExit, BorderLayout.CENTER);
	}
